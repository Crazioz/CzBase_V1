...
Config.job = {
        --StorageCheck = vector3(381.98, -816.67, 29.30),
        --HarvestWeed = vector3(380.23, -814.10, 29.30),
        --CreateJoint = vector3(375.55, -824.19, 29.30),
        Vestiaire = vector3(894.182, -171.504, 74.70),
        TaxiAction = vector3(908.268, -155.717, 74.10),
}

Config.Blip = {
		Pos   = {x = 908.254, y = -154.653, z = 74.340},
...
Config.Zones = {
	...
	VehicleDeleter = {
		Pos   = {x = 896.97180175781, y = -142.53619384766, z = 76.876068115234},
		Size  = {x = 1.0, y = 1.0, z = 1.0},
		Color = {r = 255, g = 0, b = 0},
		Type  = 36, Rotate = true
	},
