SET @faction_name = 'vagos'; -- Remplacer par le gang ou la faction que vous voulez
SET @society_name = 'society_vagos'; -- Idem avec society_
SET @faction_Name_Caps = 'Vagos'; -- Idem avec une majuscule
