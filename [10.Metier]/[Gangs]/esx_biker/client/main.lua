...
function SetVehicleMaxMods(vehicle)
  ...
  local props = {
    ...
    modSuspension   = 3,
    modTurbo        = true,
    SetVehicleCustomPrimaryColour(vehicle,255,216,0),
    SetVehicleCustomSecondaryColour(vehicle,255,216,0),
  }
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    {label = "Tenu Soldat", value = 'biker_wear'},
	{label = "Tenu O.G", value = 'biker2_wear'}
  }
  ...
  ESX.UI.Menu.CloseAll()
    ...
    ESX.UI.Menu.Open(
	  ...
	  elseif data.current.value == 'biker2_wear' then
		TriggerEvent('skinchanger:getSkin', function(skin)
			local clothesSkin = {
				['bags_1'] = 0, ['bags_2'] = 0,
...
local blips = {
 ...
 -- {title="~y~biker", colour=5, id=84, x = 326.88, y = -2033.65, z = 20.65}
  }
...
AddEventHandler('esx_biker:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.faction ~= nil and PlayerData.faction.name == 'biker' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.faction ~= nil and PlayerData.faction.name == 'biker' then
      ...
      for k,v in pairs(Config.GangStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.faction ~= nil and PlayerData.faction.name == 'biker' and PlayerData.faction.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.faction ~= nil and PlayerData.faction.name == 'biker' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.faction ~= nil and PlayerData.faction.name == 'biker' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'biker_actions') and (GetGameTimer() - GUI.Time) > 150 then
