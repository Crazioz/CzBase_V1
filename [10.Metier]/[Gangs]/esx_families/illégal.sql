SET @faction_name = 'families'; -- Remplacer par le gang ou la faction que vous voulez
SET @society_name = 'society_families'; -- Idem avec society_
SET @faction_Name_Caps = 'Families'; -- Idem avec une majuscule
