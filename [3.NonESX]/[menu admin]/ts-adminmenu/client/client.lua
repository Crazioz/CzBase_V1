...
local menu = MenuV:CreateMenu(" ", 'Developed By CraziozFR', 'topright', 102, 0, 204, 'size-150', 'template1', 'menuv',
    'mainmenu')
local onlineplayers = MenuV:CreateMenu(" ", 'Joueurs en ligne', 'topright', 102, 0, 204, 'size-150', 'template1', 'menuv',
    'onlineplayers')
local onlineplayers_each = MenuV:CreateMenu(" ", 'Joueurs en ligne', 'topright', 102, 0, 204, 'size-150', 'template1',
    'menuv', 'onlineplayers_each')

local playeroptions = MenuV:CreateMenu(" ", 'Options liées au joueur', 'topright', 102, 0, 204, 'size-150', 'template1',
    'menuv', 'playerrelatedoption')

local playeroptions2 = MenuV:CreateMenu(" ", 'Options du joueur', 'topright', 102, 0, 204, 'size-150', 'template1',
    'menuv', 'playerrelatedoption2')
local playeroptions_custom = MenuV:CreateMenu(" ", 'Personnalisation  Ped', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'playerrelatedoption_ped')

local playeroptions_custom_customize = MenuV:CreateMenu(" ", 'Personnalisation  Ped Menu', 'topright', 102, 0, 204,
    'size-150', 'template1', 'menuv', 'playerrelatedoption_ped2')

local vehicleoptions = MenuV:CreateMenu(" ", 'Options liées au véhicule', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehiclerelatedoption')

local vehicleoptions_vehiclespawn = MenuV:CreateMenu(" ", 'Apparition de véhicule', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehiclerelatedspawner')

local vehicleoptions_vehicleop = MenuV:CreateMenu(" ", 'Options de véhicule', 'topright', 102, 0, 204, 'size-150',
...
local vehicleoptions_vehicleop_mod = MenuV:CreateMenu(" ", 'Mod Menu', 'topright', 102, 0, 204, 'size-150', 'template1',
    'menuv', 'vehmodmenu')
local vehicleoptions_vehicleop_mod_colormenu = MenuV:CreateMenu(" ", 'Menu couleur', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehmodmenucolor')
local vehicleoptions_vehicleop_mod_colors = MenuV:CreateMenu(" ", 'Couleurs classiques', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehmodmenuclasiccol')
local vehicleoptions_vehicleop_mod_tyresmoke = MenuV:CreateMenu(" ", 'Couleurs de la fumée des pneus', 'topright', 255, 0, 0,
    'size-150', 'template1', 'menuv', 'vehmodmenutyrsmok')
local vehicleoptions_vehicleop_mod_metal = MenuV:CreateMenu(" ", 'Couleurs Métal', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehmodmenumetalcol')
local vehicleoptions_vehicleop_mod_matte = MenuV:CreateMenu(" ", 'Couleurs mates', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehmodmenumattecol')
local vehicleoptions_vehicleop_mod_neon = MenuV:CreateMenu(" ", 'Options néon', 'topright', 102, 0, 204, 'size-150',
    'template1', 'menuv', 'vehmodmenuneon')
local miscsettings = MenuV:CreateMenu(" ", 'Paramètres divers', 'topright', 102, 0, 204, 'size-150', 'template1', 'menuv',
    'miscsett')
local rockstar = MenuV:CreateMenu(" ", 'Éditeur Rockstar', 'topright', 102, 0, 204, 'size-150', 'template1', 'menuv',
    'rockstar')
...
local LoadOnlinePlayersEach = function()
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.ChangeSkin') then
        ...
        local onlineplayers_each_sendm = onlineplayers_each:AddButton({
            ...
            description = "Changer l'option de skin pour le joueur",
            value = "changesk",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.OpenInventory') then
        ...
        local onlineplayers_each_openinv = onlineplayers_each:AddButton({
            ...
            description = "Afficher l'inventaire du joueur",
            value = "openinv",
            false,
            select = function(i)
                MenuV:CloseAll()
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.SetJob') then
        ...
        local onlineplayers_each_setjob = onlineplayers_each:AddButton({
            icon = '📗',
            label = "Définir le travail",
            description = "Définir le travail du joueur",
            value = "setj",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.SetFaction') then
        ...
        local onlineplayers_each_setfaction = onlineplayers_each:AddButton({
            icon = '📗',
            label = "Définir la faction",
            description = "Changer la faction du joueur",
            value = "setf",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.GiveItem') then
        ...
        local onlineplayers_each_giveitem = onlineplayers_each:AddButton({
            icon = '🎁',
            label = "Donner un objet à un joueur",
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.GiveItemName') then
        ...
        RegisterCommand('gi', function(source, args, raw)
            local input = lib.inputDialog('TS Admin Menu', { "ID Joueur", "Item Name" })
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.RemoveInventoryItem') then
        ...
        local onlineplayers_each_removeitem = onlineplayers_each:AddButton({
            icon = '🗑',
            label = "Supprimer objet d'inventaire",
            description = "Supprimer un objet d'inventaire à un joueur",
            value = "removeinv",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.GiveMoney') then
        ...
        local onlineplayers_each_givem = onlineplayers_each:AddButton({
            ...
            false,
            select = function(i)
                local input = lib.inputDialog('Ajouter de l\'argent au compte- TSAdmin', { "Account Name (money, bank, black_money)", "Amount" })
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.RemoveMoney') then
        ...
        local onlineplayers_each_removem = onlineplayers_each:AddButton({
            icon = '💵',
            label = "Supprimer de l'argent à un joueur",
            description = "Retirer de l'argent",
            value = "givemon",
            false,
            select = function(i)
                local input = lib.inputDialog('Supprimer l\'argent du compte - TSAdmin', { "Account Name (money, bank, black_money)", "Amount" })
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.License') then
        ...
        local onlineplayers_each_lic = onlineplayers_each:AddButton({
            icon = '✨',
            label = "Ajouter/supprimer une licence",
            description = "Ajouter/supprimer une licence",
            value = "addrmlicense",
            false,
            select = function(i)
                local input = lib.inputDialog('TS Admin Menu - Gestionnaire de licence', { "License Name" })
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.Heal') then
        ...
        local onlineplayers_each_heal = onlineplayers_each:AddButton({
            icon = '✨',
            label = "Guérir le joueur",
            description = "Guérir le joueur",
            value = "heal",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.Revive') then
        ...
        local onlineplayers_each_revive = onlineplayers_each:AddButton({
            icon = '❤️',
            label = "Faire revivre le joueur",
            description = "Faire revivre le joueur",
            value = "rev",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.Goto') then
        ...
        local onlineplayers_each_goto = onlineplayers_each:AddButton({
            icon = '🛸',
            label = "Téléporter sur un joueur",
            description = "Téléporter sur un joueur",
            value = "goto",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.Bring') then
        ...
        local onlineplayers_each_bring = onlineplayers_each:AddButton({
            icon = '🚀',
            label = "Amener un joueur",
            description = "Amener un joueur",
            value = "bring",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.SetWaypoint') then
        ...
        local onlineplayers_each_waypoint = onlineplayers_each:AddButton({
            icon = '🔍',
            label = "Se TP sur marker",
            description = "Se TP sur marker",
            value = "waypointgoto",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.PRINTID') then
        ...
        local onlineplayers_each_printid = onlineplayers_each:AddButton({
            ...
            description = "Copier les identifiants des joueurs",
            value = "printid",
            false,
            select = function(i)
...
local LoadVehicleOptions = function()
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.DeleteVehicle') then
        ...
        local vehicleoptions_vehicleop_deleter = vehicleoptions:AddButton({
            icon = '🚙',
            label = 'Supprimer les véhicules dans la zone ',
            value = 'dvr',
            description = 'Supprimer les véhicules dans la zone',
            select = function(i)
                local input = lib.inputDialog('TS Admin Menu - Supprimer les véhicules dans la zone', { "Radius" })
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.UnlockVehicle') then
        ...
        local vehicleoptions_vehicleop_lockpick = vehicleoptions:AddButton({
            icon = '🚙',
            label = 'Déverrouiller le véhicule',
            value = 'unc',
            description = 'Déverrouiller le véhicule le plus proche',
            select = function(i)
    ...
    local vehicleoptions_vehrelated_spawn = vehicleoptions:AddButton({
        icon = '🚙',
        label = 'Spawner de véhicule',
        value = vehicleoptions_vehiclespawn,
        description = 'Faire spawn un véhicule'
    })
    ----------------------------------------------------------------------------
    -- VEHICLE SPAWNER
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.Spawner') then
        ...
        CreateThread(function()
            ...
            vehicleoptions_vehiclespawn:AddButton({
                icon = '',
                label = "Faire apparaître un véhicule personnalisé",
                description = "Faire apparaître un véhicule personnalisé",
                value = 'custom',
                false,
                select = function(i)
                    local input = lib.inputDialog('TS Admin Menu - Apparition de véhicule', { "Spawn Code" })
            ...
            for k, v in pairs(vehicleslist) do
                ...
                vehicleoptions_vehiclespawn:AddButton({
                    icon = '',
                    label = k,
                    description = "Montrer " .. k .. ' Véhicules',
                    value = spawnermenu[k],
                    false
                })
                Wait(100)
                    ...
                    spawnermenu[k]:AddButton({
                        ...
                        select = function(i)
                            if cooldown then
                                lib.notify({
                                    title = 'TS Admin Menu',
                                    description = 'Veuillez patienter un peu avant de réapparaître',
                                    type = 'inform'
                                })
                                return
                            end
    ...
    local vehicleoptions_vehrelated = vehicleoptions:AddButton({
        icon = '🚙',
        label = 'Options de véhicule',
        value = 'vehicleoptions_vehicleop',
        description = 'Options de véhicule',
        select = function(i)
            ...
            if veh ~= 0 then
                ...
                lib.notify({
                    title = 'TS Admin Menu',
                    description = 'Vous n\'êtes dans aucun véhicule',
                    type = 'error'
                })
            end
        end
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.Modmenu') then
        ...
        local vehicleoptions_vehicleop_mod_colortyr = vehicleoptions_vehicleop_mod_colormenu:AddButton({
            icon = '',
            label = 'Couleurs de la fumée des pneus',
        ...
        vehicleoptions_vehrelated:On("select", function()
            ...
            if veh ~= 0 then
                ...
                vehicleoptions_vehicleop_mod:AddButton({
                    ...
                    description = 'Menu couleur du véhicule'
                })
                ...
                for k, v in ipairs(colors) do
                    vehicleoptions_vehicleop_mod_colors:AddButton({
                        ...
                        label = v.name,
                        value = v.colorindex,
                        description = 'Appliquer ' .. v.name .. ' Couleur au véhicule',
                        select = function(i)
                            local ped = PlayerPedId()
                ...
                for k, v in ipairs(tyrecolors) do
                    vehicleoptions_vehicleop_mod_tyresmoke:AddButton({
                        ...
                        label = v.name,
                        value = 'tyr',
                        description = 'Appliquer ' .. v.name .. ' Couleur à la fumée des pneus',
                        select = function(i)
                            local ped = PlayerPedId()
                            veh = GetVehiclePedIsIn(ped, false)
                            if veh ~= 0 then
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.NumberPlate') then
        ...
        local vehicleoptions_vehicleop_setplate = vehicleoptions_vehicleop:AddButton({
            ...
            description = "Modifier le texte de la plaque d'immatriculation",
            value = "numbertext",
            false,
            select = function(i)
                local input = lib.inputDialog('TS Admin Menu - Changeur de plaques', { "Plate" })
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.MultiplierSpeed') then
        ...
        local vehicleoptions_vehicleop_enginem_R = vehicleoptions_vehicleop:AddRange({
            icon = '🚀',
            label = 'Multiplicateur de moteur',
            min = 0,
            max = 10,
            value = 0,
            saveOnUpdate = true
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.FlipVehicle') then
        ...
        local vehicleoptions_vehicleop_flip = vehicleoptions_vehicleop:AddButton({
            ...
            value = 'n',
            description = 'Définir correctement le véhicule',
            select = function(i)
                local ped = PlayerPedId()
                local veh = GetVehiclePedIsIn(ped, false)
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.DeleteVehicle') then
        ...
        local vehicleoptions_vehicleop_delete = vehicleoptions_vehicleop:AddButton({
            ...
            value = 'n',
            description = 'Supprimer le véhicule dans lequel vous vous trouvez',
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.Repair') then
        ...
        local vehicleoptions_vehicleop_repair = vehicleoptions_vehicleop:AddButton({
            ...
            description = "réparation de véhicule",
            value = "repairveh",
            false,
            select = function(i)
                local veh = GetVehiclePedIsIn(PlayerPedId(), false)
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.Wash') then
        ...
        local vehicleoptions_vehicleop_wash = vehicleoptions_vehicleop:AddButton({
            ...
            description = "Nettoyer le véhicule",
            value = "washveh",
            false,
            select = function(i)
                local veh = GetVehiclePedIsIn(PlayerPedId(), false)
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.KeepClean') then
        ...
        local vehicleoptions_vehicleop_keepclean = vehicleoptions_vehicleop:AddConfirm({
            icon = '🚿',
            label = "Garder le véhicule propre",
            value = "no"
        })
    ...
    if IsPlayerAllowed('TSAdmin.VehicleRelatedOptions.SetDirt') then
        ...
        local vehicleoptions_vehicleop_setdirt = vehicleoptions_vehicleop:AddRange({
            icon = '🦠',
            label = 'Définir la saleté du véhicule',
            min = 0,
            max = 15,
            value = 0,
            saveOnUpdate = true
...
local LoadPlayerOptions = function()
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.GiveCar') then
        ...
        local playeroptions_reviveid = playeroptions:AddButton({
            icon = '🚗',
            label = "Donner une voiture",
            description = "Donnez la voiture dans laquelle vous vous trouvez actuellement",
            value = "givec",
            false,
            select = function(i)
                ...
                if veh ~= 0 then
                    ...
                    local input = lib.inputDialog('TS Admin Menu - Donner une voiture', { "Player ID" })
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.DeleteCar') then
        ...
        local playeroptions_reviveid = playeroptions:AddButton({
            ...
            description = "Supprimer la voiture de la plaque",
            value = "delcar",
            false,
            select = function(i)
                local input = lib.inputDialog('TS Admin Menu - Supprimer la voiture', { "Plate" })
    ...
    local playeroptions_playerrelated = playeroptions:AddButton({
        icon = '🧍‍♂️',
        label = 'Options joueur',
        value = playeroptions2,
        description = 'Options joueur'
    })
    local playeroptions_playerrelated = playeroptions:AddButton({
        icon = '🧍‍♂️',
        label = 'Options Ped',
        value = playeroptions_custom,
        description = 'Options Ped'
    })
    ----------------------------------------------------------------------------
    -- GODMODE
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.Armor') then
        ...
        local playeroptions_armor = playeroptions2:AddSlider({
            icon = '💙',
            label = 'Définir armure',
            value = 'armor',
            values = { {
                label = 'Armure super légère',
                value = 20,
                description = '20% Armure'
            }, {
                label = 'Armure légère',
                value = 40,
                description = '40% Armure'
            }, {
                label = 'Armure standard',
                value = 60,
                description = '60% Armure'
            }, {
                label = 'Armure lourde',
                value = 80,
                description = '80% Armure'
            }, {
                label = 'Armure super lourde',
                value = 100,
                description = '100% Armure'
            } }
        })
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.CleanClothes') then
        ...
        local playeroptions_cleanclothes = playeroptions2:AddButton({
            icon = '🚿',
            label = "Nettoyer vêtements des joueurs",
            description = "Nettoyer les vêtements des joueurs",
            value = "clean",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.WetClothes') then
        ...
        local playeroptions_wetclothes = playeroptions2:AddButton({
            icon = '🧺',
            label = "Mouillés vêtements du joueur",
            description = "Mouillés les vêtements du joueur",
            value = "wet",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.DryClothes') then
        ...
        local playeroptions_dryclothes = playeroptions2:AddButton({
            icon = '🔅',
            label = "Sécher vêtements du joueur",
            description = "Sécher les vêtements du joueur",
            value = "dry",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.ChangeSkin') then
        ...
        local playeroptions_custom_changeskin = playeroptions_custom:AddButton({
            icon = '👕',
            label = "Changer d'apparence",
            description = "Changer d'apparence",
            value = "pedappear",
            false,
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.ChangeSkin') then
        ...
        local playeroptions_custom_changeskin = playeroptions_custom:AddButton({
            icon = '👕',
            label = "Apparence personnalisée",
            description = "Changer l'apparence du ped",
    ...
    if IsPlayerAllowed('TSAdmin.PlayerOptions.ChangePed') then
        ...
        local playeroptions_custom_changeped = playeroptions_custom:AddButton({
            icon = '👦🏻',
            label = "Changer l'Addon Ped",
            description = "Changer de modèle ped",
            value = "pedaddon",
            false,
            select = function(i)
...
local LoadMiscSettings = function()
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.Teleport') then
        ...
        local misc_teleport = miscsettings:AddButton({
            icon = '🕹',
            label = 'Téléporter sur marqueur',
            value = 'tpm',
            description = 'Téléporter sur marqueur',
            select = function(i)
                ...
                if DoesBlipExist(WaypointHandle) then
                    ...
                    lib.notify({
                        title = 'TS Admin Menu',
                        description = 'Téléporté avec succès',
                        type = 'success'
                    })
                else
                    lib.notify({
        ...
        local misc_teleportcoords = miscsettings:AddButton({
            icon = '🕹',
            label = 'Téléporter aux coordonnées',
            value = 'tpm',
            description = 'Téléporter aux coordonnées',
            select = function(i)
                local input = lib.inputDialog('Téléporter aux coordonnées', { 'X Coordinate', 'Y Coordinate', 'Z Coordinate' })
                if input then
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.ClearArea') then
        ...
        local misc_cleararea = miscsettings:AddButton({
            icon = '🕹',
            label = 'Nettoyer la zone',
            value = 'clr',
            description = 'Nettoyer la zone autours',
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.Relog') then
        ...
        local misc_cleararea = miscsettings:AddButton({
            ...
            label = 'Relog',
            value = 'clr',
            description = 'Se reconnecter du serveur',
            select = function(i)
                MenuV:CloseAll()
                selectedPlayer = 0
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.PropSpawn') then
        ...
        local misc_cleararea = miscsettings:AddButton({
            icon = '👷',
            label = 'Spawner de prop',
            value = 'prp',
            description = 'Spawner de prop',
            select = function(i)
                MenuV:CloseAll()
                selectedPlayer = 0
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.Announce') then
        ...
        local misc_cleararea = miscsettings:AddButton({
            icon = '📣',
            label = 'Annonce du serveur',
            value = 'srvannc',
            description = 'Annonce du serveur',
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.StaffChat') then
        ...
        local misc_staffchat = miscsettings:AddButton({
            icon = '📣',
            label = 'Envoyer un message aux staffs',
            value = 'staff',
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.JoinQNotif') then
        ...
        local misc_joiunq = miscsettings:AddCheckbox({
            icon = '🔍',
            label = 'Rejoindre/Quitter (les notifications)',
            value = 'n'
        })
    ...
    if IsPlayerAllowed('TSAdmin.MiscSettings.Timecycle') then
        ...
        local misc_timecycles = miscsettings:AddSlider({
            icon = '🎥',
            label = 'Cycle de temps',
            value = 'cinema',
            values = Timecycles
        })
        local misc_timecycles_intensity = miscsettings:AddRange({
            icon = '🎥',
            label = 'Intensité du cycle de temps',
            min = 0,
            max = 10,
            value = 0,
            saveOnUpdate = true
...
local LoadTrollMenu = function()
    ...
    if IsPlayerAllowed('TSAdmin.TrollMenu.Fart') then
        ...
        local trollmenu_fart = trollmenu:AddSlider({
            ...
            value = 'bbfart',
            values = { {
                label = 'Pet boosté par les basses',
                value = 'bbfart',
                description = 'Jouer un pet boosté par les basses'
            }, {
                label = 'Pet commun',
                value = 'cmfart',
                description = 'Jouer un pet commun'
            }, {
                label = 'Pet puissant',
                value = 'pwrfart',
                description = 'Jouer un pet puissant'
            }, {
                label = 'Pet malodorant',
                value = 'smfart',
                description = 'Jouer un pet malodorant'
            } }
        })
    ...
    if IsPlayerAllowed('TSAdmin.TrollMenu.Truck') then
        ...
        local trollmenu_truck = trollmenu:AddButton({
            icon = '🚚',
            label = 'Camion Punchline',
            value = 'clr',
            description = 'Camion Punchline',
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.TrollMenu.Clown') then
        ...
        local trollmenu_clown = trollmenu:AddButton({
            icon = '🧛',
            label = 'Attaque de clown',
            value = 'clr',
            description = 'Attaque de clown',
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.TrollMenu.Eject') then
        ...
        local trollmenu_eject = trollmenu:AddButton({
            icon = '🦵🏻',
            label = 'Virer le joueur du véhicule',
            value = 'clr',
            description = 'Virer le joueur du véhicule',
            select = function(i)
    ...
    if IsPlayerAllowed('TSAdmin.RockstarEditor') then
        ...
        local slider = rockstar:AddSlider({
            ...
            values = { {
                ...
                label = "Enregistrer l'enregistrement",
                value = 'saveclip',
                description = ''
            }, {
                label = "Ignorer l'enregistrement",
                value = 'delclip',
                description = ''
            }, {
                label = "Ouvrir éditeur",
                value = 'editor',
                description = ''
            } }
        })
...
local LoadAdminMenu = function()
    if not loadtimeout then
        ...
        local menu_onlineplayers = menu:AddButton({
            ...
            value = onlineplayers,
            description = 'Afficher les joueurs en ligne',
            select = function(i)
        ...
        local menu_playerrelated = menu:AddButton({
            icon = '🧍‍♂️',
            label = 'Options liées à vous',
            value = playeroptions,
            description = 'Afficher les options liées à vous'
        })


        local menu_vehiclerelated = menu:AddButton({
            icon = '🚙',
            label = 'Options liées au véhicule',
            value = vehicleoptions,
            description = 'Afficher les options liées au véhicule'
        })
        ...
        local trolllmenu_button = menu:AddButton({
            ...
            label = 'Menu Troll',
            value = trollmenu,
            description = 'Ouvrir le menu des trolls'
        })
        local rockstar_button = menu:AddButton({
            icon = '📸',
            label = 'Éditeur Rockstar',
            value = rockstar,
            description = 'Paramètres Rockstar'
        })
        -------------------------------------------------------------------------
        -- SPECTATE PLAYER
        if IsPlayerAllowed('TSAdmin.OnlinePlyOptions.Spectate') then
            ...
            local onlineplayers_each_spectate = menu:AddButton({
                ...
                description = "Spectate le joueur",
                value = "specp",
                false,
                select = function(i)
...
RegisterNetEvent('ts-adminmenu:client:TruckPunchlinePly', function()
    lib.callback('ts-adminmenu:server:GetOnlinePlayers', false, function(ply)
        ...
        for k, v in pairs(ply) do
            myMenu[v.name] = {
                description = 'ID Joueur: ' .. v.source,
                arrow = false,
...
RegisterNetEvent('ts-adminmenu:client:ChangePed', function()
    Wait(500)
    local input = lib.inputDialog('TS Admin Menu - Ped Changer', { "ID Joueur", "Model Name" })
