...
ESX.RegisterCommand('ban', 'admin', function(xPlayer, args, showError)
	cmdban(xPlayer, args)
end, true, {help = Text.ban, params = {{name = "id"}, {name = "day", help = Text.dayhelp}, {name = "reason", help = Text.reason}}})

ESX.RegisterCommand('unban', 'admin', function(xPlayer, args, showError)
	cmdunban(xPlayer, args)
end, true, {help = Text.unban, params = {{name = "name", help = Text.steamname}}})

ESX.RegisterCommand('search', 'admin', function(xPlayer, args, showError)
	cmdsearch(xPlayer, args)
end, true, {help = Text.bansearch, params = {{name = "name", help = Text.steamname}}})

ESX.RegisterCommand('banoffline', 'admin', function(xPlayer, args, showError)
	cmdbanoffline(xPlayer, args)
end, true, {help = Text.banoff, params = {{name = "permid", help = Text.permid}, {name = "day", help = Text.dayhelp}, {name = "reason", help = Text.reason}}})

ESX.RegisterCommand('banhistory', 'admin', function(xPlayer, args, showError)
	cmdbanhistory(xPlayer, args)
end, true, {help = Text.history, params = {{name = "name", help = Text.steamname}, }})

ESX.RegisterCommand('banreload', 'admin', function(xPlayer, args, showError)
	BanListLoad        = false
	BanListHistoryLoad = false
	Wait(5000)
