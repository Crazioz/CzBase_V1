...
UTK.hacktime = 5000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
UTK.maxcash = 750 -- maximum amount of cash a pile can hold
UTK.mincash = 400 -- minimum amount of cash a pile holds
