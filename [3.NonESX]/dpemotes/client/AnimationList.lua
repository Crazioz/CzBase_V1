...
DP.Tactique = {
    ...
    ["rdtcs3"] = {
        "anim@radio_pose_3",
        "radio_holding_gun",
        "Accroupie main sur la radio + arme",
        AnimationOptions = {
            Prop = 'prop_cs_hand_radio',
            PropBone = 28422,
            PropPlacement = {
    ...
    ["mainholster"] = {
        ...
        "holster_stop",
        "Marcher avec Stop main sur le holster",
        AnimationOptions = {
            EmoteLoop = true,
            EmoteMoving = true,
        }
