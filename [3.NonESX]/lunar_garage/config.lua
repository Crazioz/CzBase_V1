Config = {}
Config.Webhook = 'https://discord.com/api/webhooks/1100051413972832276/coBcKdKKyHHEqkcd8ZpfmSGppjgBkQGLr-xBesnTr23_TH_F2KuTgL4FenzvMewHiopq'
Config.Locale = 'fr'
...
Config.Garages = {
    ...
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'air',
        Position = vector3(4440.3090820313,-4511.3676757813,4.184241771698),
        SpawnPosition = vector4(4440.3090820313,-4511.3676757813,4.184241771698, 110.0) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'air',
        Position = vector3(1744.2662353516,3264.9321289063,41.261707305908),
        SpawnPosition = vector4(1709.6804199219,3253.6437988281,41.041557312012, 102.0) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'boat',
    ...
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'boat',
        Position = vector3(4971.35546875,-5170.927734375,2.2613830566406),
        SpawnPosition = vector4(4942.7377929688,-5158.7045898438,0.97115260362625, 70.0) --vector4(x, y, z, heading)
    },
    {
        Visible = true, --Blip visible on map.
        Type = 'boat',
        Position = vector3(-1608.0416259766,5264.2060546875,3.9741051197052),
        SpawnPosition = vector4(-1602.6442871094,5261.1059570313,-0.4742323756218, 28.0) --vector4(x, y, z, heading)
    },
}
